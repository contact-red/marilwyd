...
actor \nodoc\ Main is TestList
  ...
  fun tag tests(test: PonyTest) =>
    ...
    test(_TestCapabilitiesRequiresAToken)
    test(_TestCapabilitiesReportPasswordChangesDisabled)
    test(_TestThirdPartyProtocolsRequiresAToken)
    test(_TestThirdPartyProtocolsReportNone)
    ...
    test(_TestAnUpwardPathIsRefused)
    test(_TestAnOrdinaryAssetPathIsServed)
    test(_TestADotDotFilenameIsNotRefused)
    ...
    test(_TestEveryBodyLimitCanFire)
    test(_TestAnOversizedKeyUploadIsRefused)
    test(_TestADeeplyNestedKeyUploadIsRefused)
    test(_TestADeeplyNestedDeviceDeleteIsRefused)
    ...
    test(_TestChannelNamesStripsAnnouncedMarks)
    test(_TestChannelNamesKeepsUnannouncedBytes)
